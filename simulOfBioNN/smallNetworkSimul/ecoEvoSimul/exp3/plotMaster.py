...
#lineToKeep=colorDiagram(A2onA1,C,output,"Ratio A2/A1","Concentration of cooperative species, arbitrary unit",'Ratio: Y2/Y1',"diagramm"+name+".png",uselog=False)
lineToKeep=colorDiagram(A2onA1,C,output,"Ratio A2/A1","Concentration of cooperative species, arbitrary unit",'Ratio: Y2/Y1',"diagrammLog"+name+".png",uselog=True)
