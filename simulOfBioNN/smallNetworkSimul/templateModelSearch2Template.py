...
if __name__ == '__main__':
    ...
    name = "templateModel/modelSearch2"
    #generating the template:
    masks = np.array([np.array([[1,-1]])])
    outputList = None #"all" or None or list of species
    complexity="simple"
    ...
    enzyme = np.logspace(-8,-4, 4)

    for idxenzyme,e in enumerate(enzyme):
        name2 = os.path.join(name,str(idxenzyme))
